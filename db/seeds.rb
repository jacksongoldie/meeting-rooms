...
ilyas = User.create(name: 'Ilyas Rey', email: 'ilyas@goldie.com', password: 'irj2011', account_id: Account.second.id)
louis = User.create(name: 'Louis Rose', email: 'louis@goldie.com', account_id: Account.second.id)
...
#Reservations
Reservation.create(room_id: pink.id, user_id: goldie.id, start_date: "04/20/2022", end_date: "04/22/2022")
Reservation.create(room_id: orange.id, user_id: ilyas.id, start_date: "04/20/2022", end_date: "04/22/2022")
Reservation.create(room_id: blue.id, user_id: louis.id, start_date: "04/05/2022", end_date: "04/08/2022")
