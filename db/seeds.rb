...
#Users
goldie = User.create(name: 'Goldie Jackson', email: 'goldie@goldie.com')
ilyas = User.create(name: 'Ilyas Rey', email: 'ilyas@goldie.com')
louis = User.create(name: 'Louis Rose', email: 'louis@goldie.com')
